...
def process_frame(frame):
    ...
    if results.pose_landmarks:
        ...
        if not pose_ellipses.initialized:
            ...
            pose_ellipses.center_left = (initial_left_hip_coords[0] + 10, initial_left_hip_coords[1] - 33)
            pose_ellipses.center_right = (initial_right_hip_coords[0] - 10, initial_right_hip_coords[1] - 33)
